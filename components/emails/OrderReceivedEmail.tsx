...
export function OrderReceivedEmail({
  ...
  const baseUrl =
    process.env.NODE_ENV === "development"
      ? "http://localhost:3000"
      : "https://sukronsabari-casecobra.com";
        ...
        <Container style={container}>
          <Section style={message}>
            ...
            <Text style={global.text}>
              ...
              once your package has been shipped. Delivery ussually take 2 days.
            </Text>
          ...
          <Section style={paddingY}>
            <Row>
              ...
              >
                Please contact us if your have any questions. (If your reply to
                this email, we won&apos;t be able to see it.)
              </Text>
            </Row>
            <Row>
              <Text style={footer.text}>
                &copy; CustomCaseCobra, Inc. All Rights Reserved.
              </Text>
            </Row>
          </Section>
        </Container>
